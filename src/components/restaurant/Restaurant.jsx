...
function Restaurant() {
    ...
    let addItem = (index) => {
        let _menuList = [...menuList]; // recreate array
    ...
    let makePayment = async () => {
        ...
        var options = {
            key: "rzp_test_ll5LeJlltbgJMg", // Enter the Key ID generated from the Dashboard
            amount: order.amount, // rupee to paise
            currency: order.currency,
            name: "Zomato Order",
            description: "Make a payment for your orders",
            ...
            handler: async function (response){
                ...
                let { data } = await axios.post('http://localhost:5003/api/verify-payment', verifyData);
                if(data.status === true) {
    ...
    return (
        ...
        >
         <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
                <div className="modal-header">
                    <h5 className="modal-title" id="exmapleModalToggleLabel">
                        {rDetails.name}
                    </h5>
                    <button
                    type="button"
                ...
                <div className="modal-body">
                    ...
                    {/* <div className="row p-2">
                        <div className="col-8">
                            ...
                            <p className="small text-muted">Deep-fried cauliflower florets tossed in pungent spices to 
                                form a flavorsome dry curry</p>
                        </div>
                        <div className="col-4 d-flex justify-content-end">
                            <div className="menu-food-item">
                                <img src="/images/" alt="" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            ...
                            <div className="d-flex justify-content-between">
                                ...
                                { user === false ? ( 
                                <button disabled className="btn mb-1 btn-danger align-self-start">
                                    Login to place order
                                </button>) :( <div
                                className="btn-sm p-3 mb-1 btn-danger align-self-start"
                                data-bs-toggle="modal"
                                href="#modalMenuList"
                                role="button"
